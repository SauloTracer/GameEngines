...
public class GETileset {
	...
	protected GEImage mImage;
	protected Rect mTempTileArea = new Rect();
	protected Point mTileDimensions = new Point(0, 0);

	public GETileset(GEImage image, Point tilesNum, Rect drawableTileArea) {
	...
	public Rect getDrawableTileArea() {
		return mDrawableTileArea;
	}

	public GEImage getImage() {
		return mImage;
	}

	public int get1dNumberOfTiles() {
		return m2dNumberOfTiles.x * m2dNumberOfTiles.y;
	} // Retorna o total de tiles

	public Point get2dNumberOfTiles() {
		return m2dNumberOfTiles;
	}
	...
	public Rect getTile(int x, int y) {
		...
		mTempTileArea.set(left + mDrawableTileArea.left, top
				+ mDrawableTileArea.top, left + mDrawableTileArea.right, top
				+ mDrawableTileArea.bottom);
